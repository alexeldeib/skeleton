        ...
        <div className="mt-16">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => (
              <div key={index} className="flex flex-col bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 transition-all duration-300 hover:shadow-xl">
                <div className="p-2 bg-primary/10 rounded-lg w-12 h-12 flex items-center justify-center text-primary mb-5">
                  {feature.icon}
                </div>
